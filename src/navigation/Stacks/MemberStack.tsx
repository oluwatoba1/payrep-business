...
import ManageVerfiers from "@screens/Private/Kidashi/KidashiMembers/MemberDetails/ManageVerfiers";
...
export default function MembersStack() {
	return (
		...
		>
			...
			<Stack.Screen name='ManageVerfiers' component={ManageVerfiers} />
		</Stack.Navigator>
	);
}
