...
import {formatToInternationalPhoneNumber} from '@utils/Helpers';
...
export default function FacialRecognition({
  ...
  const handleNavigation = () => {
    params.source === 'forgot_password'
      ? navigate('ResetPassword', {username: params.username || ''})
      : navigateToLogin();
  };
  ...
  const onSubmit = async () => {
    ...
    if (cameraPermission === RESULTS.GRANTED) {
      const formData = {
        ...
        identityData: {
          idType: customer?.kyc?.bvn_verification_status ? 'bvn' : 'nin',
