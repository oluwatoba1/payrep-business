...
export {default as ChangePin} from './General/SecuritySettings/ChangePin';
export {default as OtpVerification} from './General/SecuritySettings/ResetPin/OtpVerification';
export {default as PinChangeFacialVerification} from './General/SecuritySettings/ResetPin/PinChangeFacialVerification';
export {default as NewPin} from './General/SecuritySettings/ResetPin/NewPin';
...
export {default as MeansOfIdentification} from './General/AccountLimit/TierTwoUpgrade/MeansOfIdentification';
export {default as KycVerification} from './General/AccountLimit/TierTwoUpgrade/KycVerification';
export {default as NINVerification} from './General/AccountLimit/TierTwoUpgrade/NINVerification';
export {default as BusinessIncorporation} from './General/AccountLimit/BusinessIncorporation';
