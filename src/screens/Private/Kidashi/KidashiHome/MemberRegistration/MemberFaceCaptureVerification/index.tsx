...
type MemberFaceCaptureVerificationProps = CompositeScreenProps<
	StackScreenProps<
		MemberRegistrationStackParamList,
...
export default function MemberFaceCaptureVerification({
	navigation: { navigate, goBack },
}: MemberFaceCaptureVerificationProps) {
	...
	const onSubmit = async () => {
		...
		const phoneNumber = !!bvnData.phoneNumber
			? bvnData.phoneNumber
		...
		if (cameraPermission === RESULTS.GRANTED) {
			const formData = {
				...
				applicantData: {
					...
					email: bvnData.email || ninData.email,
				},
				identityData: {
					idType: bvnData.bvn ? "bvn" : "nin",
					idNumber: bvnData.bvn || ninData.nin,
				},
				addressData: {
					address: "",
					city: "",
