...
export default function EasySavingsWithdrawScreen({navigation: {navigate}}:EasyScreenProps) {
        ...
        <MainLayout backAction={() => {}}>
            ...
            <View style={mainSavingsStyles.container}>
                ...
                <ScrollView>
                    ...
                    />
                    {accountType === "personal_account" && <TextInput label="" placeholder="How much would you like to withdraw?" />}
                    <View style={mainSavingsStyles.dropdownAndButtonContainer}>
                        <Dropdown
                            label="Tranfer to My Payrep Account?"
                    ...
                    {showAccountType && (
                        <View style={{gap:14, margin: 16}}>
                            <RadioButton
                                options={[
                                    {title:"My Payrep Account", value:'personal_account', width:343},
                                    // {title:"Other Bank Account", value:'other_bank_account', width:343},
                                ]}
                                selectedValue={accountType}
                                onSelect={handleRadioSelect}
                                optionContainerStyle={{height:64, borderWidth:.2 }}
                    ...
                    <TextInput label="" placeholder="Narration" />
                </ScrollView>
