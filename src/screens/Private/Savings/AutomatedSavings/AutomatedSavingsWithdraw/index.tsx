...
type AutomatedScreenProps = StackScreenProps<SavingsStackParamList>;
...
export default function AutomatedSavingsWithdrawScreen({
  navigation: {navigate},
}: AutomatedScreenProps) {
      ...
      <View style={mainSavingsStyles.container}>
        ...
        <ScrollView>
          ...
          <View style={mainSavingsStyles.dropdownAndButtonContainer}>
            <Dropdown
              label="Transfer to your payrep Account?"
          ...
          <TextInput label="Narration" placeholder="Narration" />
        </ScrollView>
