...
export default function TotalSavingsWithdrawScreen({
  navigation: {navigate},
}: EasyScreenProps) {
        ...
        <ScrollView>
          ...
          <View style={mainSavingsStyles.dropdownAndButtonContainer}>
            ...
            {accountType === 'other_bank_account' && (
              <Pressable
                ...
                style={mainSavingsStyles.selectBankButton}>
                <Image
                  style={mainSavingsStyles.icon}
                  source={ScreenImages.SavingsScreen.bankIcon}
                />
          ...
          {accountType === 'other_bank_account' && (
            <View style={{}}>
              ...
              />
              <Pressable
                onPress={handleBankBeneficiaryModal}
