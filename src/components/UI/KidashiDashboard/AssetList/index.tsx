        ...
        >
            <Row gap={scale(12)} alignItems='flex-start'>
                ...
                <View style={styles.assetTitleContainer}>
                    <Row>
                        <Typography
                            title={`${asset.woman__surname} ${asset.woman__surname?.charAt(0)}. Resource` || "N/A"}
                    ...
                    <Row justifyContent='space-between' gap={scale(8)} alignItems="center">
                        <Row justifyContent="flex-start" alignItems="center" gap={scale(8)}>
                            <Typography style={styles.assetSubTitle} title={asset.product_code || ""} type='body-r' />
